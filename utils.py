...
def get_mean_noise():
    ...
    :rtype: np.ndarray
    """
    #This was the previous line getting a file from lriitano folder
    #mean_noise = np.load("/home/lriitano/svn_folder/CameraSoftware/trunk/analysis/noise_averages.npz")["arr_0"]
    
    mean_noise = np.load("/home/bryce/CTA/Bryces_CTA_project/lriitano_stuff/analysis/noise_averages.npz")["arr_0"]
    return mean_noise
